...
App.prototype = {
	...
	overWriteGoStatements: function() {
		...
		var win = this.iframe.contentWindow.Router;
		...
		win.Router.go = function() {	
			this.go('Router', Array.prototype.slice.call(arguments, 0))
		}.bind(this);
		
		win.MobiRouter.go = function() {
			this.go('MobiRouter', Array.prototype.slice.call(arguments, 0))
		}.bind(this);
	},
